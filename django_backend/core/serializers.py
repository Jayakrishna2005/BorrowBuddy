...
class ItemSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Item
        fields = ['id', 'title', 'description', 'condition', 'is_available', 'max_borrow_days', 'category_name', 'owner_id', 'owner_name', 'image', 'category', 'owner', 'average_rating', 'reviews_count', 'reviews']
...
class BookingSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Booking
        fields = ['id', 'item', 'borrower', 'status', 'request_date', 'due_date', 'return_date', 'penalty_amount', 'item_name', 'item_image', 'owner_name', 'item_owner_id', 'borrower_name', 'has_review', 'unread_count']
