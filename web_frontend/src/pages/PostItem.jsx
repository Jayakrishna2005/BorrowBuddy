...
function PostItem({ user }) {
  ...
  const [formData, setFormData] = useState({ title: '', category: '', quantity: 1 });
      ...
      <div className="glass-card" style={{ padding: '2rem' }}>
        ...
        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
          ...
          <div>
            ...
            <input type="number" name="quantity" min="1" max="1000" value={formData.quantity} onChange={handleChange} required />
          </div>
